...
> 版本 1.4.1 · 对应源码 `src/content.js` (1978 行) / `src/page-hook.js` (235 行) / `src/background.js` (250 行)
...
*文档对应 v1.4.1。修改代码时请同步更新本文档中受影响的小节（含 §3.2 的行数表与本行的版本号）。*
